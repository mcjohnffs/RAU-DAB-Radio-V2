...
void setup()
{
  ...
  xTaskCreatePinnedToCore(
      bm83_loop,   /* Task function. */
      "bm83_loop", /* String with name of task. */
      20000,       /* Stack size in bytes. */
      NULL,        /* Parameter passed as input of the task */
      1,           /* Priority of the task. */
      &Task2,      /* Task handle. */
  ...
  mcp1.init();
  mcp1.portMode(MCP23017Port::A, 0b11111111);
  delay(5);

  mcp2.init();
  mcp2.portMode(MCP23017Port::A, 0b00000111);
  delay(5);

  mcp2.writePort(MCP23017Port::A, 0b11000000);
...
void loop()
{
  ...
  conf = mcp1.readRegister(MCP23017Register::GPIO_A);
